...
def main() -> None:
    ...
    downsamp_rate = 4 if config.dataset == "LARA" else 1 #only lara to sampling
    ...
    Model = import_class(config.model) #read 'libs.models.DeST_tcn.Model'
